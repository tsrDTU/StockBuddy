...
import com.stockbuddy.domain.stocks.getActualstockInformation
                    ...
                    Scaffold {
                        SearchBar(
                            ...
                            onSearch = {
                                ...
                                getActualstockInformation(navController ,input)

                                //linjen nedenunder skal sende en string til APIen
/*
                                val stockVal = doubleArrayOf(5.0)
                                getActualstockInformation(input, stockVal)
