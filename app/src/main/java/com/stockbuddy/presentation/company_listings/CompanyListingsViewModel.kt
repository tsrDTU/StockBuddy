...
// ViewModel access data through the model layer
// check out: https://dagger.dev/hilt/gradle-setup
...
class CompanyListingsViewModel @Inject constructor(
    ...
    private fun getCompanyListings (
        ...
        viewModelScope.launch { repository.getCompanyListings(fetchFromRemote, query)
